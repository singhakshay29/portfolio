      ...
      <div className='flex justify-center my-20 relative z-10'>
        <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
          ...
          <TextGenerateEffect
            ...
            words='ResumeAnalyzer AI – Personalized Interview Preparation'
          />

          <div className='text-center space-y-4 mt-6 mb-8'>
            <p className='text-sm md:text-lg lg:text-xl text-gray-300'>
              Analyze resumes and job descriptions to generate AI-powered
              interview questions, skill gap analysis, match scores, and
            ...
            <div className='flex flex-wrap gap-3 justify-center text-sm'>
              ...
              <span className='px-3 py-1 bg-blue-500/20 rounded-full'>AWS</span>
            </div>
          </div>
          ...
          <TooltipProvider>
            <Tooltip>
              <div className='flex gap-4'>
                ...
                <TooltipTrigger asChild>
                  <a
                    href='https://github.com/singhakshay29/resumeAnalyzerAi'
                    target='_blank'
                    rel='noopener noreferrer'>
                    <MagicButton
                      title='View Source'
