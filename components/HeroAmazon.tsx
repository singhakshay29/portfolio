      ...
      <div className='flex justify-center my-20 relative z-10'>
        <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
          ...
          <TextGenerateEffect
            ...
            words='Amazon Music Clone – Modern Music Streaming Experience'
          />

          <div className='text-center space-y-4 mt-6 mb-8'>
            <p className='text-sm md:text-lg lg:text-xl text-gray-300'>
              A responsive Amazon Music clone showcasing playlist browsing, API
              integration, music sections, and modern UI interactions.
            </p>
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent
                ...
                Explore the Amazon Music clone
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
