...
const HeroSouledStore = () => {
  ...
  words="The Souled Store Clone – Modern E-Commerce Experience"
/>
...
<div className="flex flex-wrap gap-3 justify-center text-sm">
  <span className="px-3 py-1 bg-green-500/20 rounded-full">HTML</span>
  <span className="px-3 py-1 bg-green-500/20 rounded-full">CSS</span>
  <span className="px-3 py-1 bg-green-500/20 rounded-full">JavaScript</span>
  <span className="px-3 py-1 bg-green-500/20 rounded-full">React</span>
  <span className="px-3 py-1 bg-green-500/20 rounded-full">Redux</span>
</div>
            ...
            <Tooltip>
              <div className="flex gap-4">
                <TooltipTrigger asChild>
                  <a href="https://the-soul-store.vercel.app" target="_blank" rel="noopener noreferrer">
                    <MagicButton
                      title="Live Demo"
                ...
                <TooltipTrigger asChild>
                  <a href="https://github.com/singhakshay29/the_soul_store" target="_blank" rel="noopener noreferrer">
                    <MagicButton
                      title="View Source"
                      icon={<FaGithub />}
                      position="right"
...
export default  HeroSouledStore;
