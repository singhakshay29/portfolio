    ...
    <>
      <div
        ...
        className={cn(
          ...
          "jelly-blob fixed left-0 top-0 rounded-full pointer-events-none will-change-transform",
          "translate-x-[-50%] translate-y-[-50%] isolate",
          "after:content-[''] after:absolute after:inset-0 after:backdrop-invert after:rounded-full"
        )}
        style={{
          zIndex: 9999,
        }}
      ...
      <div
        className={cn(
          "w-3 h-3 rounded-full fixed translate-x-[-50%] translate-y-[-50%] pointer-events-none transition-none duration-300 isolate",
          "after:content-[''] after:absolute after:inset-0 after:backdrop-invert after:rounded-full"
        )}
        style={{
          top: y,
